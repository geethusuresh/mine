...
"<div class=\"cron-wrap pad-all\">\n"+
" <label class=\"control-label\">Every: </label>\n"+
" <select class=\"cron-select form-control\" ng-model=\"myFrequency.base\" ng-options=\"item.value as item.label for item in frequency\"></select>\n"+

" <div class=\"select-options\">\n"+
"   <div class=\"row\">\n"+
"     <div class=\"col-sm-6\">\n"+
"       <div class=\"form-group\">\n"+
"         <label class=\"control-label\" ng-show=\"myFrequency.base == 4\">on </label>\n"+
"         <select multiple class=\"form-control\" ng-show=\"myFrequency.base == 4\" class=\"cron-select day-value\" ng-model=\"myFrequency.dayValue\" ng-options=\"(value | dayName) for value in dayValue\"></select>\n"+
"       </div>\n"+
"     </div>\n"+
"   </div>\n"+
"   <div class=\"row\">\n"+
"     <div class=\"col-sm-3\">\n"+
"       <div class=\"form-group\">\n"+
"         <label class=\"control-label\" ng-show=\"myFrequency.base >= 5\">on the </label>\n"+
"         <select class=\"form-control\" ng-show=\"myFrequency.base >= 5\" class=\"cron-select day-of-month-value\" ng-model=\"myFrequency.dayOfMonthValue\" ng-options=\"(value | numeral) for value in dayOfMonthValue\"></select>\n"+
"       </div>\n"+
"     </div>\n"+
"     <div class=\"col-sm-3\">\n"+
"       <div class=\"form-group\">\n"+
"         <label class=\"control-label\" ng-show=\"myFrequency.base == 6\">of </label>\n"+
"         <select class=\"form-control\" ng-show=\"myFrequency.base == 6\" class=\"cron-select month-value\" ng-model=\"myFrequency.monthValue\" ng-options=\"(value | monthName) for value in monthValue\"></select>\n"+
...
"   <div class=\"row\">\n"+
"     <div class=\"col-sm-6\">\n"+
"         <label class=\"control-label\"  ng-show=\"myFrequency.base >= 2\">at </label>\n"+
"       <div class=\"input-group\">\n"+
"         <select class=\"form-control\" ng-show=\"myFrequency.base >= 3\" class=\"cron-select hour-value\" ng-model=\"myFrequency.hourValue\" ng-options=\"value for value in hourValue\"></select>\n"+
"         <span class=\"input-group-addon\" ng-show=\"myFrequency.base >= 3\">:</span>\n"+
"         <select class=\"form-control\" ng-show=\"myFrequency.base >= 2\" class=\"cron-select minute-value\" ng-model=\"myFrequency.minuteValue\" ng-options=\"value for value in minuteValue\"></select>\n"+
"         <span ng-show=\"myFrequency.base == 2\"> past the hour</span>\n"+
"       </div>\n"+
"     </div>\n"+
"   </div>\n"+
