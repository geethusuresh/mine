...
Tree.prototype.popupDescriptionHover = function () {
  this.$selectionContainer.on('mouseenter', 'div.item1 > span.description', function () {
  ...
  this.$selectionContainer.on('mouseleave', 'div.item1 > span.description', function () {
    var $item = jQuery(this).parent();
...
Tree.prototype.handleSectionCheckboxMarkings = function () {
  ...
  this.$selectionContainer.on('change', 'input.section[type=checkbox]', function () {
    ...
    var $items = $section.find('div.item1');
    var keys = [];
...
Tree.prototype.redrawSectionCheckboxes = function ($section) {
  ...
  var $childCheckboxes = $section.find('> div.item1 > input[type=checkbox]');
