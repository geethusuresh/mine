    ...
    */
    ...
    function start(loc, psk) {
        ...
        webSocket.onmessage = function(evt) {
            ...
            //evt.data = {"latitude":"31.00","longitude":"36.00","countrycode":"JO","country":"JO","city":"","org":"Jordan Data Communications Company LLC","latitude2":"38.62","longitude2":"-90.35","countrycode2":"US","country2":"US","city2":"Saint Louis","type":"ipviking.honey","md5":"46.185.138.77","dport":"23","svc":"telnet","zerg":""}           
    ...
    queue()
        .defer(d3.json, "/static/attackmap/data/readme-world.json")
        .defer(d3.tsv, "/static/attackmap/data/port-names.tsv")
        .defer(d3.csv, "/static/attackmap/data/country-codes.csv")
